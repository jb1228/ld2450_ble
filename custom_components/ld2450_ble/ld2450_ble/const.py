...
CMD_FACTORY_RESET = b"\xFD\xFC\xFB\xFA\x02\x00\xA2\x00\x04\x03\x02\x01"
ACK_FACTORY_RESET_REGEX = b"\xFD\xFC\xFB\xFA\x04\x00\xA2\x01" + b"(?P<ACK_FACTORY_RESET_RESULT>..)" + b"\x04\x03\x02\x01"
